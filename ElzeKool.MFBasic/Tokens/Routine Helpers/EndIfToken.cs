...
namespace ElzeKool.MFBasic.Tokens.RoutineHelpers
{
    public sealed class EndIfToken : Token
    {
        public EndIfToken(CodeParser Parser, String Content) : base(Parser, Content) { }
    }
}
