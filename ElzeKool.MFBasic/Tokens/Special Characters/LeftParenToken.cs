...
namespace ElzeKool.MFBasic.Tokens.SpecialChars
{
    public sealed class LeftParenToken : Token
    {
        public LeftParenToken(CodeParser Parser, String Content) : base(Parser, Content) { }
    }
}
