...
namespace ElzeKool.MFBasic.Tokens.Operator
{
    public sealed class MoreOrEqualToken : Token
    {
        public MoreOrEqualToken(CodeParser Parser, String Content) : base(Parser, Content) { }
    }
}
