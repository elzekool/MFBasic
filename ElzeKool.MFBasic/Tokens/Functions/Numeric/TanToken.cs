...
{
    public sealed class TanToken : NumericFunctionToken
    {
        public TanToken(CodeParser Parser, String Content) : base(Parser, Content) { }

        public override double GetNumericResult(Basic BasicIntrepeter)
        {
            double Input = 0F;

            BasicIntrepeter.CodeParser.Expect(typeof(TanToken));
            ...
            return MFToolkit.MicroUtilities.exMath.Tan(Input);
        }
    }
}
