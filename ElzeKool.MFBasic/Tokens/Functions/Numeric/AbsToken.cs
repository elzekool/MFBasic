...
{
    public sealed class AbsToken : NumericFunctionToken
    {
        public AbsToken(CodeParser Parser, String Content) : base(Parser, Content) { }

        public override double GetNumericResult(Basic BasicIntrepeter)
        {
            double Input = 0F;

            BasicIntrepeter.CodeParser.Expect(typeof(AbsToken));
            ...
            return MFToolkit.MicroUtilities.exMath.Abs(Input);
        }
    }
}
