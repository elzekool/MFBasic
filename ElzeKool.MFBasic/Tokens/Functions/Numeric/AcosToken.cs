...
{
    public sealed class ACosToken : NumericFunctionToken
    {
        public ACosToken(CodeParser Parser, String Content) : base(Parser, Content) { }

        public override double GetNumericResult(Basic BasicIntrepeter)
        {
            double Input = 0F;

            BasicIntrepeter.CodeParser.Expect(typeof(ACosToken));
            ...
            return MFToolkit.MicroUtilities.exMath.Acos(Input);
        }
    }
}
