...
{
    public sealed class ATanToken : NumericFunctionToken
    {
        public ATanToken(CodeParser Parser, String Content) : base(Parser, Content) { }

        public override double GetNumericResult(Basic BasicIntrepeter)
        {
            double Input = 0F;

            BasicIntrepeter.CodeParser.Expect(typeof(ATanToken));
            ...
            return MFToolkit.MicroUtilities.exMath.Atan(Input);
        }
    }
}
