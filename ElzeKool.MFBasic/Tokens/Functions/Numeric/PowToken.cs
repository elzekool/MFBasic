...
{
    public sealed class PowToken : NumericFunctionToken
    {
        public PowToken(CodeParser Parser, String Content) : base(Parser, Content) { }
        ...
        public override double GetNumericResult(Basic BasicIntrepeter)
        {
            ...
            BasicIntrepeter.CodeParser.Expect(typeof(PowToken));
            ...
            return MFToolkit.MicroUtilities.exMath.Pow(Input1, Input2);
        }
    }
}
