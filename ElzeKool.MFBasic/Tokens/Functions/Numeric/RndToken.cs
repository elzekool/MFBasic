...
{
    public sealed class RndToken : NumericFunctionToken
    {
        public RndToken(CodeParser Parser, String Content) : base(Parser, Content) { }
        ...
        public override double GetNumericResult(Basic BasicIntrepeter)
        {
            ...
            return (((double)Microsoft.SPOT.Math.Random(10000)) / 10000F);
        }
    }
}
