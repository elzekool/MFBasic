...
{
    public sealed class SinToken : NumericFunctionToken
    {
        public SinToken(CodeParser Parser, String Content) : base(Parser, Content) { }

        public override double GetNumericResult(Basic BasicIntrepeter)
        {
            double Input = 0F;

            BasicIntrepeter.CodeParser.Expect(typeof(SinToken));
            ...
            return MFToolkit.MicroUtilities.exMath.Sin(Input);
        }
    }
}
