...
{
    public sealed class ASinToken : NumericFunctionToken
    {
        public ASinToken(CodeParser Parser, String Content) : base(Parser, Content) { }

        public override double GetNumericResult(Basic BasicIntrepeter)
        {
            double Input = 0F;

            BasicIntrepeter.CodeParser.Expect(typeof(ASinToken));
            ...
            return MFToolkit.MicroUtilities.exMath.Asin(Input);
        }
    }
}
