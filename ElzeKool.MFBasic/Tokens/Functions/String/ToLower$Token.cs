...
{
    public sealed class ToLower__Token : StringFunctionToken
    {
        public ToLower__Token(CodeParser Parser, String Content) : base(Parser, Content) { }

        public override string GetStringResult(Basic BasicIntrepeter)
        {
            String Input = "";
            BasicIntrepeter.CodeParser.Expect(typeof(ToLower__Token));
