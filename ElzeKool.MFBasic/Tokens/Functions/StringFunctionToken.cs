...
namespace ElzeKool.MFBasic.Tokens.Functions
{
    public class StringFunctionToken : Token
    {
        public StringFunctionToken(CodeParser Parser, String Content) : base(Parser, Content) { }
    }
}
